...
import { FormControlLabel, Checkbox, Container, TextField, Button, Box, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Typography, IconButton, Dialog, DialogActions, DialogContent, DialogTitle, Backdrop } from '@mui/material';
import EditIcon from '@mui/icons-material/Edit';
import DeleteIcon from '@mui/icons-material/Delete';
import { format } from 'date-fns';
import CircularProgress from '@mui/material/CircularProgress';
import {listarBandeja, eliminarRegistro, obtenerCandidato, actualizarRequerimiento} from '../../../services/gestionHumanaServices'
  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ mt: 13 }}>
        ...
        <TableContainer component={Paper} sx={{width: '100%', overflowX: 'auto', padding:'10px'}}>
          <Table>
            <TableHead>
              <TableRow>
      ...
      <Dialog open={openUpdate} onClose={handleCloseUpdate} maxWidth="md" fullWidth>
      ...
      <Dialog open={openDelete} onClose={handleCloseDelete}>
        ...
        <DialogContent>
          <Typography>¿Estás seguro de eliminar el registro con ID {selectedId}?</Typography>
        </DialogContent>
        <DialogActions>
